...
import 'package:my_rabbit/view_result_confirm.dart';
import 'package:google_fonts/google_fonts.dart';

class ViewResultValidate extends StatefulWidget {
  final String refId;
  final String amount;
  const ViewResultValidate(
      {super.key, required this.refId, required this.amount});

  @override
  State<ViewResultValidate> createState() => _ViewResultValidateState();
}

class _ViewResultValidateState extends State<ViewResultValidate> {
  String responseText = '';
  String statusCode = '';
  ...
  void validateApiData() async {
    ...
    var http_request_body = {"ref_id": widget.refId, "amount": widget.amount};
    var request_datetime = '1684058400';
    var http_path = '/v1/bill/validate';
    ...
    //var apiUrl = 'https://bpg-test.api.rabbit.co.th/v1/bill/validate';
    var apiUrl = 'http://127.0.0.1:5000/your-validate';
                          ...
                          ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ViewResultConfirm(
                                    refId: refId,
                                  ),
                                ),
                              );
